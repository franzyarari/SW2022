<?php
	...
	$sql2="SELECT
            ...
            b.nombre,
            b.descripcion
    FROM pro_publicaciones a 
    LEFT JOIN pro_adquisiciones b ON a.adquisicion_id = b.id_adquisicion
  ...
  <section class="section-portafolio-bg">
    <div class="container">
        <header class="section-header pb-4portafolio-title text-center">
            <h3>Registro de Adquisiciones</h3>
        </header> <hr>
      <div class="row row-30">
        ...
        <div class="col-sm-6 col-lg-4">
            <a class="thumbnail thumbnail-secondary" href="/sis-admin/Proveedores" target="_blank" style="background-image: url(img/adquisiciones2.jpg)">
                <div class="thumbnail-caption">
                    <h4 class="thumbnail-heading"><?= $row['nombre']; ?></h4>
